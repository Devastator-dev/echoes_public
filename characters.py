...
Rover_Havoc=ech.Character(ech.set_sse,10825,413,1259,125,5,150,ech.weapon_emerald_of_genesis,'Havoc Rover',ech.main_ha_dmg,False,ech.desired_mainstats_list_havoc_dps,ech.set_sse,0,12,12)
'''
Havoc rover with basic stats and standard 5* weapon. You can change weapon or prefered elemental bonus here
'''

Rover_Havoc_max=ech.Character(ech.set_sse,10825,413,1259,125,5,150,ech.weapon_emerald_of_genesis,'Havoc Rover',ech.main_ha_dmg,False,ech.desired_mainstats_list_havoc_dps,ech.set_sse,0,12,12)
'''
...
Xiangli_Yao=ech.Character(ech.set_vt,10625,425,1222,125,5,166,ech.weapon_abyss_surges,'Xiangli Yao',ech.main_el_dmg,False,ech.desired_mainstats_list_electro_dps,ech.set_vt,False,0,0,12)
'''
Xiangli Yao with basic stats and standard 5* weapon. You can change weapon or prefered elemental bonus here
'''

Xiangli_Yao_max=ech.Character(ech.set_vt,10625,425,1222,125,5,166,ech.weapon_abyss_surges,'Xiangli Yao',ech.main_el_dmg,False,ech.desired_mainstats_list_electro_dps,ech.set_vt,0,0,12)
'''
...
Jinshi=ech.Character(ech.set_cl,10825,413,1259,125,13,150,ech.weapon_ages_of_harvest,'Jinshi',ech.main_sp_dmg,False,ech.desired_mainstats_list_spectro_dps,ech.set_cl,0,32,12)
'''
Jinshi with basic stats and banner 5* weapon. You can change weapon or prefered elemental bonus here
'''

Jinshi_max=ech.Character(ech.set_cl,10825,413,1259,125,13,150,ech.weapon_ages_of_harvest,'Jinshi',ech.main_sp_dmg,False,ech.desired_mainstats_list_spectro_dps,ech.set_cl,0,32,12)
'''
...
Shorekeeper=ech.Character(ech.set_rg,16713,288,1100,125,5,150,ech.weapon_variation,'Shorekeeper',ech.main_er,True,ech.desired_mainstats_list_shore,ech.set_rg,12,0,0,12)
'''
